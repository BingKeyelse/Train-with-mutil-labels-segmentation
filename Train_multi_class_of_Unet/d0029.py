...
def load_path(data_path):
    ...
    # classes = ['cam1_OK', 'cam2_OK', 'cam3_OK', 'cam4_OK', 'cam5_OK', 'cam6_OK', 'cam7_OK']
    # classes1 = ['cam1_NG', 'cam2_NG', 'cam3_NG', 'cam4_NG', 'cam5_NG', 'cam6_NG', 'cam7_NG', 'cam8_NG', 'cam9_NG', 'cam10_NG', 'cam11_NG']
    classes = ['Class1', 'Class2', 'Class3', 'Class4', 'Class5', 'Class6']
    classes1 = ['Class1_def', 'Class2_def', 'Class3_def', 'Class4_def', 'Class5_def', 'Class6_def']
...
if is_train:
    ...
    # filepath_wights="checkpoint_the_lastest.hdf5"
    # model.load_weights(filepath_wights)
    filepath= "checkpoint_the_lastest_resnet50.hdf5"
    callback = ModelCheckpoint(filepath, monitor='val_iou_score', verbose=1, save_best_only=True,mode='max')

    # model.fit_generator( train_loader, validation_data=test_loader, epochs=100, callbacks=[callback])
    model.fit( train_loader, validation_data=test_loader, epochs=100, callbacks=[callback])
